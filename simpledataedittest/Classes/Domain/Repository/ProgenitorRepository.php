...
/**
 * The repository for test-model Progenitor (the word parent would be more reasonable, but is is a reserved word.)
 */
class ProgenitorRepository extends Repository
{
