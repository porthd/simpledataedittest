 ...
 */
class ChildTest extends \TYPO3\TestingFramework\Core\Unit\UnitTestCase
{
    const CONCEIVED_AT_T_3_CON_10 = 'Conceived at T3CON10';
    /**
     * @var \Porthd\Simpledataedittest\Domain\Model\Child
     */
    ...
    {
        parent::setUp();
        $this->subject = new \Porthd\Simpledataedittest\Domain\Model\Child();
    }
